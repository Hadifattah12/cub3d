...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/02 15:24:14 by pkahil            #+#    #+#             */
/*   Updated: 2025/01/09 12:53:58 by hfattah          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// The negative sign ensures the wall column is centered 
// vertically by offsetting the top of
//  the wall slice upwards from the middle of the screen.
// Without it, the wall would be 
//  misaligned and appear below its intended position
